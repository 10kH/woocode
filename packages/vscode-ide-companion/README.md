...
The Gemini CLI Companion extension pairs with [Gemini CLI](https://github.com/woocode/woocode). This extension is compatible with both VS Code and VS Code forks.
...
By installing this extension, you agree to the [Terms of Service](https://github.com/woocode/woocode/blob/main/docs/tos-privacy.md).

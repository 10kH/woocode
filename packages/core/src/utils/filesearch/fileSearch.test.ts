...
describe('FileSearch', () => {
  ...
  it('should use .woocodeignore rules', async () => {
    ...
    expect(results).toEqual(['src/', '.woocodeignore', 'src/not-ignored.js']);
  });

  it('should combine .gitignore and .woocodeignore rules', async () => {
    tmpDir = await createTmpDir({
      '.gitignore': 'dist/',
      '.woocodeignore': 'build/',

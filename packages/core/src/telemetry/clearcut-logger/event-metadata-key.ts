...
export enum EventMetadataKey {
  ...
  WOOCODE_CLI_USER_PROMPT_LENGTH = 13,
  ...
  WOOCODE_CLI_API_REQUEST_MODEL = 20,
  ...
  WOOCODE_CLI_API_RESPONSE_MODEL = 21,

  // Logs the status code of the response.
  WOOCODE_CLI_API_RESPONSE_STATUS_CODE = 22,

  // Logs the duration of the API call in milliseconds.
  WOOCODE_CLI_API_RESPONSE_DURATION_MS = 23,

  // Logs the error message of the API call, if any.
  WOOCODE_CLI_API_ERROR_MESSAGE = 24,

  // Logs the input token count of the API call.
  WOOCODE_CLI_API_RESPONSE_INPUT_TOKEN_COUNT = 25,

  // Logs the output token count of the API call.
  WOOCODE_CLI_API_RESPONSE_OUTPUT_TOKEN_COUNT = 26,

  // Logs the cached token count of the API call.
  WOOCODE_CLI_API_RESPONSE_CACHED_TOKEN_COUNT = 27,

  // Logs the thinking token count of the API call.
  WOOCODE_CLI_API_RESPONSE_THINKING_TOKEN_COUNT = 28,

  // Logs the tool use token count of the API call.
  WOOCODE_CLI_API_RESPONSE_TOOL_TOKEN_COUNT = 29,
  ...
  // Logs the model id of the API call.
  WOOCODE_CLI_API_ERROR_MODEL = 30,

  // Logs the error type.
  WOOCODE_CLI_API_ERROR_TYPE = 31,

  // Logs the status code of the error response.
  WOOCODE_CLI_API_ERROR_STATUS_CODE = 32,

  // Logs the duration of the API call in milliseconds.
  WOOCODE_CLI_API_ERROR_DURATION_MS = 33,
  ...
  WOOCODE_CLI_LOOP_DETECTED_TYPE = 38,
  ...
  WOOCODE_CLI_SLASH_COMMAND_NAME = 41,

  // Logs the subcommand of the slash command.
  WOOCODE_CLI_SLASH_COMMAND_SUBCOMMAND = 42,

  // Logs the status of the slash command (e.g. 'success', 'error')
  WOOCODE_CLI_SLASH_COMMAND_STATUS = 51,
  ...
  WOOCODE_CLI_RESPONSE_FINISH_REASON = 43,

  // Logs the result of the next speaker check
  WOOCODE_CLI_NEXT_SPEAKER_CHECK_RESULT = 44,
  ...
  WOOCODE_CLI_MALFORMED_JSON_RESPONSE_MODEL = 45,
  ...
  WOOCODE_CLI_KITTY_TRUNCATED_SEQUENCE = 52,

  // Logs the length of the kitty sequence that overflowed.
  WOOCODE_CLI_KITTY_SEQUENCE_LENGTH = 53,
  ...
  WOOCODE_CLI_RESEARCH_OPT_IN_STATUS = 66,

  // Logs the contact email for research participation
  WOOCODE_CLI_RESEARCH_CONTACT_EMAIL = 67,

  // Logs the user ID for research events
  WOOCODE_CLI_RESEARCH_USER_ID = 68,

  // Logs the type of research feedback
  WOOCODE_CLI_RESEARCH_FEEDBACK_TYPE = 69,

  // Logs the content of research feedback
  WOOCODE_CLI_RESEARCH_FEEDBACK_CONTENT = 70,

  // Logs survey responses for research feedback (JSON stringified)
  WOOCODE_CLI_RESEARCH_SURVEY_RESPONSES = 71,
  ...
  WOOCODE_CLI_INVALID_CHUNK_ERROR_MESSAGE = 75,

  // Logs the attempt number for a content retry.
  WOOCODE_CLI_CONTENT_RETRY_ATTEMPT_NUMBER = 76,

  // Logs the error type for a content retry.
  WOOCODE_CLI_CONTENT_RETRY_ERROR_TYPE = 77,

  // Logs the delay in milliseconds for a content retry.
  WOOCODE_CLI_CONTENT_RETRY_DELAY_MS = 78,

  // Logs the total number of attempts for a content retry failure.
  WOOCODE_CLI_CONTENT_RETRY_FAILURE_TOTAL_ATTEMPTS = 79,

  // Logs the final error type for a content retry failure.
  WOOCODE_CLI_CONTENT_RETRY_FAILURE_FINAL_ERROR_TYPE = 80,

  // Logs the total duration in milliseconds for a content retry failure.
  WOOCODE_CLI_CONTENT_RETRY_FAILURE_TOTAL_DURATION_MS = 81,

  // Logs the current nodejs version
  WOOCODE_CLI_NODE_VERSION = 83,
}

...
The tool appends the provided `fact` to a special `WOOCODE.md` file located in the user's home directory (`~/.woocode/WOOCODE.md`). This file can be configured to have a different name.

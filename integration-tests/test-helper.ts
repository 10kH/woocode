...
export class TestRig {
  ...
  getDefaultTimeout() {
    ...
    if (env.WOOCODE_SANDBOX) return 30000; // 30s in containers
  ...
  setup(
    ...
    const geminiDir = join(this.testDir, '.woocode');
    ...
    const settings = {
      ...
      sandbox: env.WOOCODE_SANDBOX !== 'false' ? env.WOOCODE_SANDBOX : false,
